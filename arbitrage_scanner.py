...
def calculate_spread(prices):
    ...
    for asset, p in prices.items():
        ...
        if c_price > k_price:
            ...
            net_spread = gross_spread - TOTAL_TRADE_FEE - (WITHDRAWAL_FEES[asset] / k_price)
        ...
        if k_price > c_price:
            ...
            net_spread = gross_spread - TOTAL_TRADE_FEE - (WITHDRAWAL_FEES[asset] / c_price)
...
def main():
    ...
    while True:
        try:
            ...
            for asset, p in prices.items():
                print(f"  {asset:4s} | Kraken: ${p['kraken']:10.2f} | Crypto.com: ${p['cryptocom']:10.2f}")
